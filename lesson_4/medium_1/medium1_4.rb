...
"Goodbye". Make use of the Greeting class greet method when implementing the Hello
and Goodbye classes - do not use any puts in the Hello or Goodbye classes.
=end
...
class Hello < Greeting
  def hi
    greet(self.class) # or just "Hello"
  end
end

class Goodbye < Greeting
  def bye
    greet(self.class) # or just "Goodbye"
  end
end
