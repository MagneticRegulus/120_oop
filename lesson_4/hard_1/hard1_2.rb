...
having noticed common information and calculations they were performing for each
type of vehicle, they decided to break out the commonality into a separate class
called WheeledVehicle.

Now Alan has asked them to incorporate a new type of vehicle into their system (Catamaran)
...
Modify the class definitions and move code into a Module, as necessary, to share
